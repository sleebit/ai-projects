  ...
  return NextResponse.json(
    {
      ...
      defaultPrompts: [
        ...
        },
        {
          id: "5",
          label: "🤔 Question",
          prompt: `The tone of your all your responses, should be strictly very casual like a normal average social media user who is very curious and is always wanting to engage with others. The responses should be strictly very casual in nature, no formal tone. Your response shouldn't look like a ChatGPT/ Robot/ AI written responses. Don't use the word "Absolutely", or similar kindof words at the start of your replies.\n\n\nImagine you have encountered a tweet that piqued your curiosity? Craft a brief, friendly question as a comment (under 150 characters) that encourages the author and others to engage with it. Keep it natural, as if you're genuinely seeking information.`,
        },
        {
          id: "6",
          label: "😂 Funny",
