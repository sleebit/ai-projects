...
const FormSchema = lib/* object */.Ry({
    youtubeLink: lib/* string */.Z_().min(2, {
        message: "Youtube link is required"
    }),
    summaryType: lib/* string */.Z_({
        ...
        if (loading) {
            ...
            if (apiResp.status) {
                ...
                if (data.summaryType == "quick") {
                    summary = await getQuickSummary({
                        transcript
                    });
                } else if (data.summaryType == "detailed") {
                    summary = await getDetailedSummary({
                        transcript
                    });
                }
                setSummaries([
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                                        className: "text-2xl text-center font-semibold tracking-tight mt-4",
                                        children: "Here lies your video summarizations."
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx(Accordion, {
                                        ...
                                        children: summaries.map((video, i)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(AccordionItem, {
                                                value: `video-${i}`,
                                                children: [
                                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(AccordionTrigger, {
                                                        children: [
                                                            video.summaryType,
                                                            " - ",
                                                            video.videoTitle
                                                    ...
                                                    /*#__PURE__*/ jsx_runtime_.jsx(AccordionContent, {
                                                        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            className: "w-[80vw] md:w-[35vw] text-justify m-auto leading-relaxed",
...
var __webpack_exports__ = __webpack_require__.X(0, [763,474,51,942,858,487,101,516,499,666], () => (__webpack_exec__(59741)));
