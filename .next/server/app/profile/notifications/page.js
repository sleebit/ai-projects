...
const notificationsFormSchema = lib/* object */.Ry({
    type: lib/* enum */.Km([
        "all",
        "mentions",
        "none"
    ...
    mobile: lib/* boolean */.O7().default(false).optional(),
    communication_emails: lib/* boolean */.O7().default(false).optional(),
    social_emails: lib/* boolean */.O7().default(false).optional(),
    marketing_emails: lib/* boolean */.O7().default(false).optional(),
    security_emails: lib/* boolean */.O7()
});
...
var __webpack_exports__ = __webpack_require__.X(0, [763,474,51,450,942,396,571,613,516,499,529,455,270], () => (__webpack_exec__(46652)));
